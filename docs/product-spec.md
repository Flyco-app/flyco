...
Phase 1H implements centralized, versioned prohibited-item guidance and records sender/traveler acknowledgements at publication and acceptance. It provides neutral cross-border guidance without asserting corridor-specific law. Booking participants can review private item information; public discovery remains narrow. Final legal text, customs policy, support operations and reporting remain launch decisions.
