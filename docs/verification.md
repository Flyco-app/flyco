...
## Phase 1A hosted-hardening verification (in progress, 2026-09-19)
...
Hosted Auth configuration, SMTP, deployment, browser E2E, direct Data API JWT tests and Sentry probe remain unverified until a sending domain is chosen/verified and interactive Supabase/Vercel/Sentry dashboard access is available. They must not be reported as passed until completed.
